package com.felixkoppe.firerecorder;
 ...
 * FireRecorderPlugin
 */
public class FireRecorderPlugin implements MethodCallHandler {
  private final Registrar registrar;
  private boolean isRecording = false;
  private static final String LOG_TAG = "FireRecorder";
  ...
  public static void registerWith(Registrar registrar) {
    final MethodChannel channel = new MethodChannel(registrar.messenger(), "fire_recorder");
    channel.setMethodCallHandler(new FireRecorderPlugin(registrar));
  }

  private FireRecorderPlugin(Registrar registrar){
